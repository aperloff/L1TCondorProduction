...
ln -s ${CMSSWVER}/src/L1Trigger/VertexFinder/test/vertexNTupler_cfg.py
...
echo "cmsRun vertexNTupler_cfg.py ${ARGS} 2>&1"
cmsRun vertexNTupler_cfg.py ${ARGS} 2>&1

CMSEXIT=$?

rm vertexNTupler_cfg.py
